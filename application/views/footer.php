...
<footer id="footer" class="footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-3 flex-footer">
                    <div class="footer-info">
                        <h3>Combo Putra</h3>
                        <p>
                            Jl. Trunojoyo X No.2, Padangsari, Kec. Banyumanik, Kota Semarang, Jawa Tengah <br>
                            50267<br><br>
    ...
    <div class="footer-legal text-center position-relative">
        <div class="container">
            <div class="copyright">
                &copy; 2024 <strong><span>Combo Putra</span></strong> - All Rights Reserved
            </div>
            <div class="credits">
